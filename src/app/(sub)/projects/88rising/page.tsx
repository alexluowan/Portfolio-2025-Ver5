        ...
        <main>
            ...
            <section className="grid grid-cols-4 lg:grid-cols-12 gap-x-5 py-8 mx-5">
                <div className="col-start-1 col-span-full lg:col-start-3 lg:col-span-8">
                    <h1 className="font-offbit text-2xl lg:text-h1 uppercase lg:leading-10">
                        Reimagining 88risings website experience for fans to engage with their favourite artists and
                        stay informed.
                    </h1>
                    <p className="font-neuehaasunica text-h4mono lg:text-xl mt-8">
                    ...
                    <p className="mt-5 text-h4mono lg:text-xl">
                    ...
                    <div className="flex flex-row mt-10 gap-x-16 invisible md:visible lg:visible">
                        ...
                        <div className="flex flex-col w-4/5">
                            <div>
                                <h4 className="font-favoritmono text-h4monomobile lg:text-h4mono">TEAM MEMBERS</h4>
                                <p className="font-neuehaasunica text-h4mono lg:text-xl">
                        ...
                        <div className="flex flex-col w-3/5">
                            <div>
                                <h4 className="font-favoritmono text-h4monomobile lg:text-h4mono">TOOLS</h4>
                                <p className="font-neuehaasunica text-h4mono lg:text-xl">
                ...
                <div className="-mt-52 col-start-3 col-span-2 visible md:invisible lg:invisible">
                    <div>
                        <h4 className="font-favoritmono text-h4monomobile lg:text-h4mono">MY ROLE</h4>
                        <p className="font-neuehaasunica text-h4mono lg:text-xl">
                            Lead Interaction Designer, Prototyping, Visual Designer, Facilitator, Mobile Designer </p>
                    </div>
                    <div className="mt-5">
                        <h4 className="font-favoritmono text-h4monomobile lg:text-h4mono">TOOLS</h4>
                        <p className="font-neuehaasunica text-h4mono lg:text-xl">
            ...
            <div className="relative">
                {/* SVG Section */}
                <div className="pr-5 lg:pr-96 mt-20 lg:mt-40">
                    <Image
